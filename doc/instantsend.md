...
This mechanism has been integrated into Bitcore-Node-digiquian which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/digiquianpay/insight-api-digiquian#web-socket-api](https://github.com/digiquianpay/insight-api-digiquian#web-socket-api)
* API: [https://github.com/digiquianpay/insight-api-digiquian#instantsend-transactions](https://github.com/digiquianpay/insight-api-digiquian#instantsend-transactions)
...
By default, the digiquian Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the digiquian Core daemon:
