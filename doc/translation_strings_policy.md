...
This document provides guidelines for internationalization of the digiquian Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `digiquian_en.ts` remains unchanged.
