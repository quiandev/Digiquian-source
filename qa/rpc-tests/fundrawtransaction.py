...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid digiquian address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid digiquian address" in e.error['message'])
