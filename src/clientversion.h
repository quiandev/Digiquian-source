...
//! These need to be macros, as clientversion.cpp's and digiquian*-res.rc's voodoo requires it
...
/**
 * digiquiand-res.rc includes this file, but it cannot cope with real c++ code.
