    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QUIAN-light"), QVariant("light"));
    ui->theme->addItem(QString("QUIAN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("QUIAN-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("QUIAN-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("QUIAN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QUIAN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QUIAN-traditional"), QVariant("trad"));
