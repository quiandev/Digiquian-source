    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  digiquian-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the digiquian in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 QUIAN, 0.1 QUIAN, 1 QUIAN and 10 QUIAN -- sort of like the paper money you use every day.</li> \
