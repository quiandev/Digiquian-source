...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print digiquian address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "digiquian",               "masternode",             &masternode,             true,  {} },
    { "digiquian",               "masternodelist",         &masternodelist,         true,  {} },
    { "digiquian",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "digiquian",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "digiquian",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "digiquian",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
