...
2. run digiquiand with -printalert or -sendalert like this:
   /path/to/digiquiand -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.digiquian.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/digiquian Core:0.12.0.58/"));
